...
describe("LE-001 Phase 5 cutover plan", () => {
  ...
  it("advances only the independently approved Phase 5A through Phase 5F controls", () => {
    expect(
    ...
    expect(
      LEARNER_CUTOVER_CONTROLS.learner_reporting_canonical_population
        .selectedMode,
    ).toBe("CANONICAL_PRIMARY_LEGACY_FALLBACK");
    expect(
    ...
    expect(
      LEARNER_CUTOVER_CONTROLS.learner_assignment_recipient_canonical_reference
        .selectedMode,
    ).toBe("CANONICAL_PRIMARY_LEGACY_FALLBACK");
    expect(
      LEARNER_CUTOVER_CONTROLS.learner_submission_canonical_self.selectedMode,
    ).toBe("CANONICAL_PRIMARY_LEGACY_FALLBACK");
    expect(
