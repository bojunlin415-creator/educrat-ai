...
describe("LE-001 Phase 5D Assignment class expansion architecture", () => {
  it("keeps authority and parity framework-neutral and product-neutral", () => {
    const forbidden = [
      "react",
      "next",
      "@supabase",
  ...
  it("has no circular production imports", () => {
    ...
    const aliasPrefix = "@/lib/learner-convergence/assignment-class-expansion/";
