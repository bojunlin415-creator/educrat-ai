...
describe("LE-001 Phase 5F submission self-resolution architecture", () => {
  it("keeps authority contracts framework-neutral and product-persistence free", () => {
    const forbidden = [
      "react",
      "next",
      "@supabase",
  ...
  it("has no circular production imports", () => {
    ...
    const aliasPrefix = "@/lib/learner-convergence/submission-self-resolution/";
