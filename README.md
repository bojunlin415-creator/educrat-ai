...
- [AI-002 Adaptive Learning Engine](docs/product/ai-002-adaptive-learning-engine.md)：已完成實作、等待產品審查的 Weak Knowledge Detection、Knowledge Gap、Difficulty Recommendation、Learning Recommendation 與 Learning Path foundation
